...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="css-main/boo.css" >
        <style>
...
<div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true">
    ...
    <section class="container my-5">
        ...
        <div class="row text-center">
            ...
            <div class="col">
                <a href="bookss.html" class="icon-link text-primary">
                    <!-- Icon representing books and history -->
                    <i class="bi bi-book display-4 mb-2"></i>
                    <p class="fw-bold">Books & History</p>
                </a>
            </div>
        </div>
    </section>
    ...
    <div class="row g-4">
        ...
        <div class="grid">
            <div class="card">
              <div class="image"><img src="imgs/book1.jpg" alt="" height="150px" width="150px"></div>
              <p>Abdullah</p>
              <button>View</button>
            </div>
            <!-- Repeat this card as needed -->
            <div class="card">
              <div class="image"><img src="imgs/book2.jpg" alt="" height="150px" width="150px"></div>
              <p>Ameen</p>
              <button>View</button>
            </div>
            <div class="card">
              <div class="image"><img src="imgs/book3.webp" alt="" height="150px" width="150px"></div>
              <p>Omar</p>
              <button>View</button>
            </div>
      
            <div class="card">
              <div class="image"><img src="imgs/book4.jpg" alt="" height="150px" width="150px"></div>
              <p>Saad</p>
              <button>View</button>
            </div>
            <div class="card">
              <div class="image"><img src="imgs/book5.webp" alt="" height="150px" width="150px"></div>
              <p>Fahad</p>
              <button>View</button>
            </div>
            <div class="card">
              <div class="image"><img src="imgs/book6.jpg" alt="" height="150px" width="150px"></div>
              <p>Yassen</p>
              <button>View</button>
            </div>
            <div class="card">
              <div class="image"><img src="imgs/book7.jpg" alt="" height="150px" width="150px"></div>
              <p>Gomaiz</p>
              <button>View</button>
            </div>
            <div class="card">
              <div class="image"><img src="imgs/book.jpg" alt="" height="150px" width="150px"></div>
              <p>Ronaldo</p>
              <button>View</button>
            </div>
